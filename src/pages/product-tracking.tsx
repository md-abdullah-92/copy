...
export default function ProductTracking() {
  ...
  return (
    ...
    <ScrollAnimationWrapper>
      <motion.div
      //max width of 4xl, margin auto, margin top 24, padding 6, 8, 16
      //keep space from top and bottom
      ...
      >
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 shadow-lg rounded-xl p-8 md:p-12">
          ...
          <div className="flex justify-center mt-10">
            <button
              ...
              className="px-6 py-3 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105"
            >
